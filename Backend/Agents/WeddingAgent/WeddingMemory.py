...
class WeddingMemory(SQLModel, table=True):
...
class MemoryMangement:
    ...
    def search_memory(self, query: str,  memory_table: str, top_k=5):
...
if __name__ == "__main__":
    _MemoryManagement = MemoryMangement()
    
    _MemoryManagement.store_memory(memory_text="The maid of honor is Sarah L")
